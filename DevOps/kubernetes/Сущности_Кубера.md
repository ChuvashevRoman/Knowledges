...
Кубер - это проект с открытым исходным кодом для управления контейнерами, размещённых в основном на нескольких хостах и объекдинённых в кластер. Необходим в основном для упрощения развёртывания, обслуживания и масштабирования приложения.
